...
|----------|--------------|-------------|
| [**Telex Cultural Coworker**](https://github.com/Aghaulor-Gift/telex-cultural-coworker/) | AI agent that provides cultural insights using FastAPI + Google Gemini API | FastAPI, Python, Gemini API |
---

## Future Projects
| Project | Description | Tech Stack |
|----------|--------------|-------------|
| [**UTF-8 Validation**](https://github.com/Aghaulor-Gift/utf8-validation) | Validates UTF-8 encoding using bitwise operations | Python |
